...
export class MyPrism extends CGFobject {
    ...
    initBuffers() {
        ...
        for(var i = 0; i < this.slices - 1; i++){
            let reference = i * 2 + 1;
            let reference_back = this.slices * 2 + reference;
        ...
        //last face
        this.indices.push(this.slices * 2 - 1, (this.slices * 2 - 1) * 2, this.slices * 2 );
        this.indices.push(this.slices * 2, 0, this.slices * 2 - 1 );
        ...
        lastIDX = this.vertices.length - 1
        for(var i = 0; i < this.slices - 1; i++){
            let reference = i * 2 + 1;
            let reference_back = this.slices * 2 + reference;
        ...
        this.indices.push(this.slices * 2 + 1, this.slices * 2 * 2 - 1, lastIDX);
