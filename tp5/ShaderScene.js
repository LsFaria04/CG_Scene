...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/shader1anim.vert", "shaders/shader1anim.frag"),
			new CGFshader(this.gl, "shaders/shader1.vert", "shaders/shader1sepia.frag"),
		...
		this.shadersList = {
			...
			'Convolution': 8,
			'Shader Custom': 9,
			'Shader Custom Anim' : 10,
			"Shader Custom Sepia": 11,
			"Water Shader" : 12
		};
